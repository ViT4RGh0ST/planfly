 ...
 *
 * A root that is not there yields nothing rather than throwing: the plugin's
 * `src/` held ten hand-written tools and stopped existing when they moved to
 * MCP, and a guard that crashes on a directory somebody legitimately deleted
 * stops guarding everything else while it is being argued with.
 */
