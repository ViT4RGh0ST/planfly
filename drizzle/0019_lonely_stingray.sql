...
--> statement-breakpoint
DROP INDEX "mcp_pending_operations_lookup_idx";--> statement-breakpoint
ALTER TABLE "mcp_pending_operations" ALTER COLUMN "token_id" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "mcp_pending_operations" ADD COLUMN "credential_id" text;--> statement-breakpoint
UPDATE "mcp_pending_operations" SET "credential_id" = 'token:' || "token_id"::text WHERE "credential_id" IS NULL;--> statement-breakpoint
ALTER TABLE "mcp_pending_operations" ALTER COLUMN "credential_id" SET NOT NULL;--> statement-breakpoint
...
CREATE INDEX "mcp_pending_operations_lookup_idx" ON "mcp_pending_operations" USING btree ("id","household_id","user_id","credential_id");
